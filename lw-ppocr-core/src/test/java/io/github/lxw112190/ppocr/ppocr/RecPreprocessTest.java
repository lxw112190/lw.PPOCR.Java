...
public final class RecPreprocessTest {
    ...
    public void preservesAspectRatioAndUsesChwNormalization() {
        ...
        RecPreprocessResult result = RecPreprocess.resizeNormalize(new BgrImage(pixels, 2, 2, 6), 8);
        Assert.assertEquals(4, result.getResizedWidth());
        ...
        Assert.assertEquals(128.0f * 2.0f / 255.0f - 1.0f, output[4], 0.00001f);
    }
}
